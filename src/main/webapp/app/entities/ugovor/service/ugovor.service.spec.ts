  ...
  describe('Ugovor Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        predmetUgovora: 'AAAAAAA',
        nazivPonudjaca: 'AAAAAAA',
        brojDatumTenderskeDokumntacije: 'AAAAAAA',
        brojDatumOdlukeIzbora: 'AAAAAAA',
        brojDatumPonude: 'AAAAAAA',
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            brojUgovora: 'BBBBBB',
            datumUgovora: currentDate.format(DATE_FORMAT),
            predmetUgovora: 'BBBBBB',
            nazivPonudjaca: 'BBBBBB',
            brojDatumTenderskeDokumntacije: 'BBBBBB',
            brojDatumOdlukeIzbora: 'BBBBBB',
            brojDatumPonude: 'BBBBBB',
      ...
      describe('addUgovorToCollectionIfMissing', () => {
        ...
        it('should add only unique Ugovor to an array', () => {
          const ugovorArray: IUgovor[] = [{ id: 123 }, { id: 456 }, { id: 67199 }];
