...
public class PrvorangiraniResource {
    ...
    public List<Prvorangirani> findByPrvorangiraniUgovor(@RequestParam Integer sifraPonude) {
        return prvorangiraniRepository.findPrvorangiraniBySifraPonude(sifraPonude);
    }
}
